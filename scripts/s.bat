...
:: 불러올 환경 변수 목록 설정
set "VARIABLES=PROJECT_DIR_ROOT GRAPHQL_ROOT_FOLDER"
...
start cmd /k "cd %PROJECT_DIR_ROOT%/%GRAPHQL_ROOT_FOLDER% && nodemon ."
@REM start cmd /k "cd %PROJECT_DIR_ROOT%/%GRAPHQL_ROOT_FOLDER% && node ."
